...
class ReweighterTester {
  public:
    ...
    RawDataForReweightingAndMetainformation getRawDataForReweightingAndMetainformation(std::vector<unsigned int> momentsToBeReweighted,
                                                                                       std::vector<int> binsizesToBeUsed,
                                                                                       bool reweightProbabilityDistribution = true)
    {
    ...
    static void printRawDataForReweightingAndMetainformation(RawDataForReweightingAndMetainformation rawDataAndInfo)
    {
        ...
        for (auto i : rawDataAndInfo.namesOfParametersIgnoringMetaParameters)
            std::cout << i << " - ";
        std::cout << "\b\b\033[K\n";
        std::cout << "- valuesOfSimulationParametersIgnoringMetaParameters: size "
                  << rawDataAndInfo.valuesOfSimulationParametersIgnoringMetaParameters.size() << "  ->  ";
        ...
        std::cout << "\b\b\033[K\n";
        std::cout << "- valuesOfSpecifiedLogZ: ";
        for (auto j : rawDataAndInfo.valuesOfSpecifiedLogZ)
            std::cout << j << " ";
        std::cout << "\n";
        std::cout << "- newRangesOfParameters: ";
        for (auto j : rawDataAndInfo.newRangesOfParameters)
            std::cout << j.first << " <-> " << j.second << " | ";
        std::cout << "\b\b\033[K\n";
        std::cout << "- newNumberOfPointsOfParameters: ";
        for (auto j : rawDataAndInfo.newNumberOfPointsOfParameters)
            std::cout << j << " - ";
        std::cout << "\b\b\033[K\n";
        ...
        std::cout << "- momentsToBeReweighted: ";
        for (auto j : rawDataAndInfo.momentsToBeReweighted)
            std::cout << j << " ";
        std::cout << "\n";
        std::cout << "- binsizesToBeUsed: ";
        for (auto j : rawDataAndInfo.binsizesToBeUsedForBinning)
            std::cout << j << " - ";
        std::cout << "\b\b\033[K\n";
        std::cout << "----------------------------------------------------------------------\n";
    }
