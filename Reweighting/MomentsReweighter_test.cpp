...
public:
    ...
    MomentsReweighterTest(std::initializer_list<std::string> options, std::vector<unsigned int> momentsToBeReweighted = {}, std::vector<int> binsizesToBeUsed = {}, bool reweightProbabilityDistribution = true)
        : MomentsReweighterAbstract(ReweighterTester(options).getRawDataForReweightingAndMetainformation(momentsToBeReweighted, binsizesToBeUsed, reweightProbabilityDistribution)){};
    ...
    std::vector<realFloat> testCalculateLogZAtNewPointsUsingBinnedDataAndLeavingOutOneEntry(const int entryToBeLeftOut, std::vector<realFloat> logZSim){
        return calculateLogZAtNewPoints(getValuesOfNewParameters(), true, entryToBeLeftOut, &logZSim);
    }

    void testPrepareObservablesBeforeReweighting(std::vector<realFloat>& minima){
...
//The following two print functions are only temporarily for testing reasons.
    ...
    void testExtractAndSetReweightedMomentsAndMomentsEstimators(const std::vector<std::vector<realFloat> >& reweightedObservablesFromRawData,
...
BOOST_AUTO_TEST_SUITE(logZ)
    ...
    BOOST_AUTO_TEST_CASE(logZ1)
	{
        ...
        realFloat referenceLogZAtNewPoints[] = {141.808725391091, 139.786001864617, 137.763562229189, 135.741409322221,
    ...
    BOOST_AUTO_TEST_CASE(logZ2)
    {
        ...
        std::vector<realFloat> newLogZ = momentsReweighterTest.testCalculateLogZAtSimulatedPointsUsingUncorrDataAndLeavingOutOneEntry(pointToBeLeftOut);
...
BOOST_AUTO_TEST_SUITE(columnsReweighting)
    ...
    BOOST_AUTO_TEST_CASE(columnsReweighting2)
    {
        ...
        realFloat referenceValuesObsNewPoints[] = {0.51136048194686, 0.51141566283263, 0.51147120976833, 0.51152713131180,
    ...
    BOOST_AUTO_TEST_CASE(columnsReweighting3)
    {
        ...
        const int numberOfObservablesInFiles = 4; //1 obs given and 4 moments asked
        const int pointToBeLeftOut = 1652;
        realFloat referenceValuesObsNewPoints[] = {0.51136310124219, 0.51141833777545, 0.51147393929166, 0.51152991432649,
    ...
    BOOST_AUTO_TEST_CASE(columnsReweighting4)
    {
        ...
        const int numberOfObservablesInFiles = 4; //1 obs given and 4 moments asked
        const int pointToBeLeftOut = 0;
        realFloat referenceValuesObsNewPoints[] = {0.51136053648952, 0.51141575105339, 0.51147133146101, 0.51152728623366,
