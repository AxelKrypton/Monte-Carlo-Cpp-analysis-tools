...
BOOST_AUTO_TEST_SUITE(build)
    ...
    BOOST_AUTO_TEST_CASE(build1) { BOOST_REQUIRE_NO_THROW(Histogram hist{1.5}); }
...
BOOST_AUTO_TEST_SUITE(buildEstimator)
    ...
    BOOST_AUTO_TEST_CASE(buildEstimator1) { BOOST_REQUIRE_NO_THROW(HistogramEstimator histEstimator{1.5}); }
