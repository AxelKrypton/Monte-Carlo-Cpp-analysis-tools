...
MomentsReweighterHelper::MomentsReweighterHelper(RawDataForReweightingAndMetainformation rawDataForReweightingAndMetainformation)
	: simulationRawDataContainer(rawDataForReweightingAndMetainformation.rawData), simulationUncorrDataContainer(rawDataForReweightingAndMetainformation.rawData),
	  ...
	  errorMethod(rawDataForReweightingAndMetainformation.errorMethod), bootstrapNumber(rawDataForReweightingAndMetainformation.bootstrapNumber), deactivateReweightingProbabilityDistribution(rawDataForReweightingAndMetainformation.deactivateReweightingProbabilityDistributions),
	  histoBinsize(rawDataForReweightingAndMetainformation.binsizeProbabilityDistribution)
{
