...
BOOST_AUTO_TEST_SUITE(build)
    ...
    BOOST_AUTO_TEST_CASE(build1)
    {
        std::initializer_list<std::string> options
            = {"-f./RealTestData/configfile_1", "--useBootstrapAsErrorMethod", "--deactivateReweightingForSkewness"};
...
BOOST_AUTO_TEST_SUITE(privateFunctions)
    ...
    {
        std::initializer_list<std::string> options = {"-f./RealTestData/configfile_7", "--useBootstrapAsErrorMethod",
                                                      "--deactivateReweightingForMean", "--deactivateReweightingForSkewness",
                                                      "--deactivateReweightingForKurtosis"};
        ReweighterTester reweighterTester(options);
        std::vector<ReweightingProcedure> reference;
    ...
    {
        std::initializer_list<std::string> options
            = {"-f./RealTestData/configfile_7", "--useBootstrapAsErrorMethod", "--deactivateReweightingForMean"};
        ReweighterTester reweighterTester(options);
        std::vector<ReweightingProcedure> reference;
...
BOOST_AUTO_TEST_SUITE(meanReweighting)
    ...
    BOOST_AUTO_TEST_CASE(meanReweighting1)
    {
        ...
        realFloat referenceValuesObs1NewPoints[] = {
            0.513201682060, 0.513258510947, 0.513316165254, 0.513374651344, 0.513433975214, 0.513494142470, 0.513555158307, 0.513617027480,
            0.513679754278, 0.513743342503, 0.513807795437, 0.513873115823, 0.513939305834, 0.514006367050, 0.514074300428, 0.514143106283,
            0.514212784255, 0.514283333291, 0.514354751616, 0.514427036709, 0.514500185286, 0.514574193271, 0.514649055778, 0.514724767094,
            0.514801320653, 0.514878709028, 0.514956923909, 0.515035956091, 0.515115795462, 0.515196430993};

        realFloat referenceValuesObs2NewPoints[] = {
            0.512565539027, 0.512620638254, 0.512676556317, 0.512733299285, 0.512790872858, 0.512849282342, 0.512908532626, 0.512968628155,
            0.513029572905, 0.513091370361, 0.513154023485, 0.513217534696, 0.513281905844, 0.513347138179, 0.513413232332, 0.513480188285,
            0.513548005351, 0.513616682143, 0.513686216557, 0.513756605745, 0.513827846094, 0.513899933203, 0.513972861865, 0.514046626048,
...
BOOST_AUTO_TEST_SUITE(suscReweighting)
    ...
    BOOST_AUTO_TEST_CASE(suscReweighting1)
    {
        ...
        std::initializer_list<std::string> options = {"-f" + fileThatDoesExist,
                                                      ...
                                                      "--newBetaRange_high=5.3509",
                                                      "--numberOfNewBetaPoints=30",
                                                      "--deactivateReweightingForMean",
                                                      "--deactivateReweightingForSkewness",
                                                      "--deactivateReweightingForKurtosis"};
        ReweighterTester reweighter(options, true);
        realFloat referenceValuesObs1NewPoints[]
            = {1.360382497662e-05, 1.380206166679e-05, 1.400187465334e-05, 1.420317840867e-05, 1.440588225665e-05, 1.460988958896e-05,
               1.481509729023e-05, 1.502139672521e-05, 1.522867261927e-05, 1.543680369204e-05, 1.564566235018e-05, 1.585511466440e-05,
               1.606502048768e-05, 1.627523344711e-05, 1.648560084400e-05, 1.669596383169e-05, 1.690615752914e-05, 1.711601110549e-05,
               1.732534802779e-05, 1.753398594168e-05, 1.774173728597e-05, 1.794840926933e-05, 1.815380404546e-05, 1.835771925196e-05,
               1.855994818922e-05, 1.876028030456e-05, 1.895850142108e-05, 1.915439410266e-05, 1.934773840867e-05, 1.953831225004e-05};

        realFloat referenceValuesObs2NewPoints[]
            = {1.427912489987e-05, 1.447082186090e-05, 1.466399284294e-05, 1.485855167371e-05, 1.505440624228e-05, 1.525145868059e-05,
               1.544960513528e-05, 1.564873585130e-05, 1.584873494864e-05, 1.604948062173e-05, 1.625084475421e-05, 1.645269338274e-05,
               1.665488615382e-05, 1.685727680922e-05, 1.705971313576e-05, 1.726203684049e-05, 1.746408385900e-05, 1.766568464595e-05,
               1.786666369691e-05, 1.806684052041e-05, 1.826602939597e-05, 1.846403963840e-05, 1.866067613976e-05, 1.885573915039e-05,
    ...
    BOOST_AUTO_TEST_CASE(suscReweighting2)
    {
        ...
        ReweighterTester reweighter(options, true);
        realFloat referenceValuesObsNewPoints[]
            = {1.180411821738e-05, 1.208232047961e-05, 1.237626373973e-05, 1.268738973464e-05, 1.301714973234e-05, 1.336698100046e-05,
               1.373827541457e-05, 1.413234305597e-05, 1.455036960651e-05, 1.499336639338e-05, 1.546211444214e-05, 1.595710172614e-05,
               1.647845354596e-05, 1.702585886609e-05, 1.759849318694e-05, 1.819493996719e-05, 1.881311462187e-05, 1.945019478350e-05,
               2.010256123064e-05, 2.076575570353e-05, 2.143446069708e-05, 2.210250796952e-05, 2.276292125730e-05, 2.340799772488e-05,
               2.402943174945e-05, 2.461848171409e-05, 2.516617797466e-05, 2.566356670136e-05, 2.610198085368e-05, 2.647332626765e-05,
               2.677036803039e-05, 2.698700072329e-05, 2.711848567277e-05, 2.716163955918e-05, 2.711496103230e-05, 2.697868722473e-05,
               2.675477541869e-05, 2.644681210945e-05, 2.605985582160e-05, 2.560022551895e-05, 2.507524896922e-05, 2.449298741691e-05,
               2.386195408399e-05, 2.319084028335e-05, 2.248826432305e-05, 2.176255198727e-05, 2.102155488620e-05, 2.027251168252e-05,
...
BOOST_AUTO_TEST_SUITE(kurtReweighting)
    ...
    BOOST_AUTO_TEST_CASE(kurtReweighting2)
    {
        ...
        ReweighterTester reweighter(options, true);
        realFloat referenceValuesObsNewPoints[] = {
            3.663706836831, 3.696484687413, 3.723885962225, 3.747903662848, 3.765346818340, 3.776222888418, 3.779868405965, 3.775221978283,
            3.762713121619, 3.740995303963, 3.709608980699, 3.669847657356, 3.621044095174, 3.563347667599, 3.497876974793, 3.425192488040,
            3.346254664697, 3.262279245763, 3.174213891238, 3.083592999229, 2.991712008107, 2.899850309765, 2.809412714627, 2.721682512149,
            2.637894251316, 2.559181676674, 2.486588832258, 2.421062038709, 2.363377226072, 2.314220158046, 2.274161525348, 2.243574635506,
            2.222823530362, 2.212114121404, 2.211507215736, 2.220941285527, 2.240339735026, 2.269438789375, 2.307890805072, 2.355298699153,
            2.411128319662, 2.474664796862, 2.545320647525, 2.622395651726, 2.704936325050, 2.792237859045, 2.883234474431, 2.977133174541,
