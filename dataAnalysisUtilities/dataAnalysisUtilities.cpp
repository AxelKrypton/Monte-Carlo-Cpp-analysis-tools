...
// TODO: Bad to pass both isMeanKnownToBeZero and parameters that contains the first. Once done the todo in  dataAnalysisUtilities.hpp, this
// is basically solved!
static EstimateAndError
calcVarianceAndError(DataSample& sampleIn, bool isMeanKnownToBeZero, Parameters* parameters = NULL, bool shouldUseBinning = false)
{
...
EstimateAndError calcSkewnessAndErrorOfDataSample(DataSample sampleIn, Parameters parameters)
{
     ...
     */
    DataSample thirdCentralMomentSample = parameters.isMeanKnownToBeZero ? sampleIn.getNthMomentPerDataPoint(3)
                                                                         : sampleIn.getNthCentralMomentPerDataPoint(3);
...
EstimateAndError calcKurtosisAndErrorOfDataSample(DataSample sampleIn, Parameters parameters)
{
     ...
     *   gamma_2 = beta_2 - 3
     */
    DataSample fourthCentralMoment = parameters.isMeanKnownToBeZero ? sampleIn.getNthMomentPerDataPoint(4)
                                                                    : sampleIn.getNthCentralMomentPerDataPoint(4);
