...
DataSampleAnalyzer::DataSampleAnalyzer(DataSample& sample, Parameters parametersIn) : parameters(parametersIn)
{
    /**
...
MeanAnalyzer::MeanAnalyzer(DataSample& sample, const Parameters parameters) : AnalyzerWrapper("Mean", getFilenameForObservables(parameters))
{
...
AnalyzerWrapper::AnalyzerWrapper(std::string name, std::string outputFilename) : AnalyzerWrapperBasic(name, outputFilename) {}
